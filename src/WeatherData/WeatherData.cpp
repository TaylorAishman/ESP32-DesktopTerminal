...
int WeatherData_GetIconId(int weather_id){
  ...
  switch(weather_id) {
    ...
    case 200 ... 232:
      icon_id =38; // weather_128_tstorms
      break;
      
    // Group 3xx: Drizzle
    case 300 ... 321:
      icon_id =1; // weather_128_chancerain
      break;
      
    // Group 5xx: Rain
    case 500 ... 504: // Light to extreme rain
      icon_id =34; // weather_128_rain
      break;
    case 511: // Freezing rain
      icon_id =35; // weather_128_sleet
      break;
    ...
    case 620 ... 622: // Shower snow
      icon_id =7; // weather_128_flurries
      break;
      
    // Group 7xx: Atmosphere
    case 701: // Mist
      icon_id =8; // weather_128_fog
      break;
    case 711: // Smoke
      icon_id =9; // weather_128_hazy
      break;
    case 721: // Haze
      icon_id =9; // weather_128_hazy
      break;
    ...
    // Group 800: Clear
    case 800:
      icon_id =37; // weather_128_sunny
      break;
      
    // Group 80x: Clouds
    case 801: // Few clouds: 11-25%
      icon_id =32; // weather_128_partlycloudy
      break;
    case 802: // Scattered clouds: 25-50%
      icon_id =32; // weather_128_partlycloudy
      break;
    case 803: // Broken clouds: 51-84%
      icon_id =10; // weather_128_mostlycloudy
      break;
    case 804: // Overcast clouds: 85-100%
      icon_id =6; // weather_128_cloudy
      break;
      
    default:
      icon_id =39; // weather_128_unknown
      break;
   }
...
int WeatherData_CurrentParse(WeatherData* data, HTTPClient* http){
  String serverName = "https://api.openweathermap.org/data/2.5/weather?lat=" LATITUDE "&lon=" LONGITUDE "&appid=" WEATHER_API_KEY "&units=imperial";
  ...
  if (httpResponseCode > 0) {
    ...
    data->icon_id = WeatherData_GetIconId(doc["weather"][0]["id"].as<int>());
...
int WeatherData_ForecastParse(WeatherData* data, int max_entries, HTTPClient* http){
  String serverName = "https://api.openweathermap.org/data/2.5/forecast?lat=" LATITUDE "&lon=" LONGITUDE "&appid=" WEATHER_API_KEY "&units=imperial";
  http->begin(serverName.c_str());
  ...
  if (httpResponseCode > 0) {
    ...
    for (JsonObject item : list) {
      ...
      data[count].icon_id = WeatherData_GetIconId(item["weather"][0]["id"].as<int>());
